...
let topfilterlist =ref([
  {id:1,name:'first',label:'热门筛选',list:['天安门广场','王府井','北京大学']},
...
let filterlist =ref([
    ...
    {title:'支付方式',list:['在线付款','到店付款','闪付']},
    {title:'房型',list:['双床房','三床房','单人大床','大床房','特大床房']},
...
<template>
    <div class="topfilter">
        ...
        <div class="topfilter-price">
             <el-button  size="small" type="info" v-for="(v,i) in pricelist" :key="i" plain>{{v}}</el-button>
        </div>
        <div>
            <h4>高级筛选</h4>
        </div>
